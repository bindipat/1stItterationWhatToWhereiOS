...
class IntroPageVC: UIPageViewController {
    ...
    weak var tutorialDelegate: IntroPageViewControllerDelegate?

    private(set) lazy var orderedViewControllers: [UIViewController] = {
        // The view controllers will be shown in this order
        return [self.newColoredViewController("FirstIntroVC"),
            self.newColoredViewController("SecondIntroVC"),
            self.newColoredViewController("ThirdIntroVC"),
            self.newColoredViewController("FourthIntroVC")]
    }()
    ...
    func newColoredViewController(_ viewControllerName: String) -> UIViewController {
...
protocol IntroPageViewControllerDelegate: AnyObject {
