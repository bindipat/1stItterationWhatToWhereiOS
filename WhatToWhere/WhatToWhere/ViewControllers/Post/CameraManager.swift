...
//             Create the metadata input and add it to the session.
    ...
    open func fileOutput(_ captureOutput: AVCaptureFileOutput, didFinishRecordingTo outputFileURL: URL, from connections: [AVCaptureConnection], error: Error?)
    {
        stopCaptureSession()
        if error == nil {
//            AVAsset.squareCropVideo(inputURL: outputFileURL as NSURL, completion: { (sqVideoURL) in
//                let image : UIImage = ManagerClass.getThumbnailFromVideo(outputFileURL as URL)!
//                var newImage = UIImage()
//                if self.setOrientation == "landscapeRight"
//                {
//                    newImage = image.rotate(radians: (Float.pi / 2))!
//                }
//                else if self.setOrientation == "landscapeLeft"{
//                    newImage = image.rotate(radians: (Float.pi / 2))!
//                }else{
//                    newImage = image
//                }
...
//                    self.compressVideo(inputURL: outputFileURL as URL, outputURL: compressedURL) { (session) in
//                        switch session.status {
//                        case .unknown :
//                            print("Compress unknown")
//                            break
//                        case .waiting :
//                            print("Compress Waiting")
//                            break
//                        case .exporting :
//                            print("Compress exporting")
//                            break
//                        case .completed :
//                            print("Compressed")
//                            break
...
//                            break
//                        }
//                        self.gotToUploadVC(newImage: newImage, compressedURL: compressedURL)
//
//                    }
//                }
//
//            })
    ...
    func gotToUploadVC(newImage: UIImage, compressedURL: URL)
    {
...
//                let viewController = Application.Delegate.navigationController.topViewController
//
//                if (viewController?.isKind(of: CameraViewController.self))!
//                {
//                    (viewController as! CameraViewController).isNext = true
//                }
//                let uploadVideoVC: UploadVideoVC = Application.Delegate.mainStoryBoard.instantiateViewController(withIdentifier: "UploadVideoVC") as! UploadVideoVC
//                uploadVideoVC.videoImage = newImage
//                uploadVideoVC.videoSelectURL = compressedURL
//                uploadVideoVC.strSelectType = "camera"
//                Application.Delegate.navigationController.pushViewController(uploadVideoVC, animated: true)
        }
    }
    private func compressVideo(inputURL: URL, outputURL: URL, handler:@escaping (_ session: AVAssetExportSession)-> Void) {
